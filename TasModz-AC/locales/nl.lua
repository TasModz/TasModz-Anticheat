Locales['nl'] = {
    ...
    -- Ban strings
    ['checking'] = '⛓️ Tasify Anticheat | U wordt momenteel gecontroleerd...',
    ['user_ban_reason'] = '⛓️ Tasify Anticheat | Je bent verbannen van deze server ( 𝗚𝗲𝗯𝗿𝘂𝗶𝗸𝗲𝗿𝘀𝗻𝗮𝗮𝗺: %s )',
    ['user_kick_reason'] = '⛓️ Tasify Anticheat | Je bent gekicked ( 𝗥𝗲𝗱𝗲𝗻: %s )',
    ['banlist_ban_reason'] = 'De speler heeft geprobeerd om \'%s\' aan te roepen',
    ['banlist_not_loaded_kick_player'] = '⛓️ Tasify Anticheat | Onze bans zijn niet geladen, je zult een paar seconden moeten wachten. Probeer het later nog eens.',
    ['ip_not_found'] = '⛓️ Tasify Anticheat | We konden je IP niet vinden',
    ['ip_blocked'] = '⛓️ Tasify Anticheat | U heeft een VPN actief, schakel deze uit om de server te joinen | Verkeerd? Neem contact op met de server owners',
