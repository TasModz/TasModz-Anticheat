...
TAC.TriggerServerCallback = function(name, cb, ...)
    ...
    TriggerServerEvent('tasifyanticheat:triggerServerCallback', name, TAC.CurrentRequestId, token, ...)
...
TAC.TriggerServerEvent = function(name, ...)
    ...
    TriggerServerEvent('tasifyanticheat:triggerServerEvent', name, token, ...)
end
...
RegisterNetEvent('tasifyanticheat:serverCallback')
AddEventHandler('tasifyanticheat:serverCallback', function(requestId, ...)
